...
from tasbot.decorators import MinArgs
...
class Main(IPlugin):
	...
	def cmd_said(self,args,cmd):
		if len(args) > 2 and args[2].startswith("!"):
			self.oncommandfromuser(args[1],args[0],False,args[2],args[3:],self.socket)

	@MinArgs(3)
	def cmd_saidprivate(self,args,cmd):
		if len(args) > 1 and args[1].startswith("!"):
			self.oncommandfromuser(args[0],"PM",True,args[1],args[2:],self.socket)
